...
*/
/**************************************************************************/
Adafruit_ADS1015::Adafruit_ADS1015(const char* device_id, uint8_t i2cAddress) 
{
   m_i2cDeviceId = device_id;
...
*/
/**************************************************************************/
Adafruit_ADS1115::Adafruit_ADS1115(const char* device_id, uint8_t i2cAddress)
{
   m_i2cDeviceId = device_id;
...
*/
/**************************************************************************/
void Adafruit_ADS1015::begin(bool silent) {
  if (!silent) printf("setting up ADS with m_i2cAddress = %d\n", m_i2cAddress);
  m_i2cFd = wiringPiI2CSetupInterface(m_i2cDeviceId, m_i2cAddress);
  if (!silent) printf("m_i2cFd = %d\n", m_i2cFd);
}
